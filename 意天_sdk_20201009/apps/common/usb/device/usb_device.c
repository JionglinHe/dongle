...
int usb_device_mode(const usb_dev usb_id, const u32 class)
{
    ...
    if ((class & HID_CLASS) == HID_CLASS) {
        usb_add_desc_config(usb_id, class_index++, hid_desc_config);//interface0
        usb_add_desc_config(usb_id, class_index++, hid_desc_config);//interface1
        usb_add_desc_config(usb_id, class_index++, hid_desc_config);//interface2
    }
